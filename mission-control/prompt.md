...
> Enter mission control mode. Break this into tasks, build the dependency graph, and parallelize with background agents. Verify agent work. Report status as tables.
