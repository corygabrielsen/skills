...
| 7    | `Paused`          | Stderr header `Idle`. Loop mode: decide had nothing to do this iteration. Side-effect mode: any of `--advance-level`, `--drop-level`, `--restart-from-floor`, `--mark-retro-clean` (when current is at any level **other than** the configured ceiling — both below AND above), `--mark-retro-changes`, `--mark-address-passed` completing successfully.                                                                                                                                                                                                                                                     |
