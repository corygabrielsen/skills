...
review` CLI supports prompts with target modes. All non-help
  ...
  **BinaryError tolerance.** Every side-effect call documents an
  ...
  (exit 70) on any side-effect invocation regardless of flag — see the
  ...
  orchestrators MUST treat exit 70 as a possible additional outcome
