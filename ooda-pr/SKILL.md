...
| Name          | Refers to                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ooda-attest` | Companion CLI that writes attestation files at `<state-root>/<pr-id>/<axis>_attest.json` for five axes: `pr-meta`, `doc-review`, `claude-review`, `review-class`, `closeout`. Each `Sync*` / `Review*` / `Address*` / `Attest*` / `Closeout` handoff (exit 4) instructs the receiving agent to run the matching subcommand after completing the work. `review-class` is the sweep witness: it requires one `--class` per issue class the reviewers raised, each paired with a `--sites` list of every `path:line` swept, and the loop holds `AddressThreads` / `AttestReviewClass` at `BlockingFix` until the attestation is newer than every review thread — resolving threads alone does not clear the gate. `closeout` is the convergence gate — it fires only when every other axis is silent and gates `HandoffHuman` on an explicit agent sign-off. Run `ooda-attest --help` for the full surface. |
