...
mod tests {
    ...
    fn iteration_decided_event_carries_five_artifact_refs() {
        ...
        // dashboard.json — the tier-grouped human-shaped projection;
        // distinct from decision_envelope.json (the Execute/Halt
        // runner input). One name, one schema after the CURRENT.json
        // refactor.
        assert!(
